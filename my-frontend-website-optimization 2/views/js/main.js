...
function updatePositions() {
  ...
  //Calculating once and using in for loop.
...
//optimizes animations to run in a single paint cycle.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // To Determine the number of pizzas generated based on viewport height.
  var rows = Math.round(window.screen.height / s);
  var pizzaCount = rows * cols;
  var movingPizzas1 = document.getElementById("movingPizzas1");
  //moved out of for loop therefore computed once
  var elem;
